...
func QueryBlocks(blockNum int64, client *ethclient.Client) *types.Block {
...
func QueryTx(client *ethclient.Client, transaction types.Transaction) {
	// we need to add block *types.Block parameter for the commented out portions
